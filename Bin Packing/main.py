...
#     print(gcms.bin_info(1002))
#     print(gcms.bin_info(1003))
#     print(gcms.bin_info(1004))
#     print(gcms.bin_info(1005))
...
if __name__ == "__main__":
    ...
    for obj_id, size, color in initial_object_data:
        ...
        try:
            ...
            print(f"Added Object ID: {obj_id}, Size: {size}, Color: {color.name}, Bin ID: {gcms.object_info(obj_id)}")
        except NoBinFoundException:
            print(f"Failed to add Object ID: {obj_id}, Size: {size}, Color: {color.name} - No suitable bin found")
    # for i in range(10):
        # print(gcms.bin_info(1001+i))
    print_separator()
